...
static constexpr const uint16_t json_crc = 0xd271;

static constexpr const uint16_t per_axis_offset = 305;
...
enum { 
    ...
    AXIS__CONTROLLER__CONFIG__VEL_INTEGRATOR_LIMIT = 272,
    AXIS__CONTROLLER__CONFIG__VEL_LIMIT = 273,
    AXIS__CONTROLLER__CONFIG__VEL_LIMIT_TOLERANCE = 274,
    AXIS__CONTROLLER__CONFIG__VEL_RAMP_RATE = 275,
    AXIS__CONTROLLER__CONFIG__TORQUE_RAMP_RATE = 276,
    AXIS__CONTROLLER__CONFIG__CIRCULAR_SETPOINTS = 277,
    AXIS__CONTROLLER__CONFIG__CIRCULAR_SETPOINT_RANGE = 278,
    AXIS__CONTROLLER__CONFIG__STEPS_PER_CIRCULAR_RANGE = 279,
    AXIS__CONTROLLER__CONFIG__HOMING_SPEED = 280,
    AXIS__CONTROLLER__CONFIG__INERTIA = 281,
    AXIS__CONTROLLER__CONFIG__AXIS_TO_MIRROR = 282,
    AXIS__CONTROLLER__CONFIG__MIRROR_RATIO = 283,
    AXIS__CONTROLLER__CONFIG__TORQUE_MIRROR_RATIO = 284,
    AXIS__CONTROLLER__CONFIG__LOAD_ENCODER_AXIS = 285,
    AXIS__CONTROLLER__CONFIG__INPUT_FILTER_BANDWIDTH = 286,
    AXIS__CONTROLLER__CONFIG__ANTICOGGING__INDEX = 287,
    AXIS__CONTROLLER__CONFIG__ANTICOGGING__PRE_CALIBRATED = 288,
    AXIS__CONTROLLER__CONFIG__ANTICOGGING__CALIB_ANTICOGGING = 289,
    AXIS__CONTROLLER__CONFIG__ANTICOGGING__CALIB_POS_THRESHOLD = 290,
    AXIS__CONTROLLER__CONFIG__ANTICOGGING__CALIB_VEL_THRESHOLD = 291,
    AXIS__CONTROLLER__CONFIG__ANTICOGGING__COGGING_RATIO = 292,
    AXIS__CONTROLLER__CONFIG__ANTICOGGING__ANTICOGGING_ENABLED = 293,
    AXIS__CONTROLLER__CONFIG__MECHANICAL_POWER_BANDWIDTH = 294,
    AXIS__CONTROLLER__CONFIG__ELECTRICAL_POWER_BANDWIDTH = 295,
    AXIS__CONTROLLER__CONFIG__SPINOUT_MECHANICAL_POWER_THRESHOLD = 296,
    AXIS__CONTROLLER__CONFIG__SPINOUT_ELECTRICAL_POWER_THRESHOLD = 297,
    AXIS__CONTROLLER__AUTOTUNING__FREQUENCY = 298,
    AXIS__CONTROLLER__AUTOTUNING__POS_AMPLITUDE = 299,
    AXIS__CONTROLLER__AUTOTUNING__VEL_AMPLITUDE = 300,
    AXIS__CONTROLLER__AUTOTUNING__TORQUE_AMPLITUDE = 301,
    AXIS__CONTROLLER__MECHANICAL_POWER = 302,
    AXIS__CONTROLLER__ELECTRICAL_POWER = 303,
    AXIS__CONTROLLER__START_ANTICOGGING_CALIBRATION = 307,
    AXIS__ENCODER__ERROR = 308,
    AXIS__ENCODER__IS_READY = 309,
    AXIS__ENCODER__INDEX_FOUND = 310,
    AXIS__ENCODER__SHADOW_COUNT = 311,
    AXIS__ENCODER__COUNT_IN_CPR = 312,
    AXIS__ENCODER__INTERPOLATION = 313,
    AXIS__ENCODER__PHASE = 314,
    AXIS__ENCODER__POS_ESTIMATE = 315,
    AXIS__ENCODER__POS_ESTIMATE_COUNTS = 316,
    AXIS__ENCODER__POS_CIRCULAR = 317,
    AXIS__ENCODER__POS_CPR_COUNTS = 318,
    AXIS__ENCODER__DELTA_POS_CPR_COUNTS = 319,
    AXIS__ENCODER__HALL_STATE = 320,
    AXIS__ENCODER__VEL_ESTIMATE = 321,
    AXIS__ENCODER__VEL_ESTIMATE_COUNTS = 322,
    AXIS__ENCODER__CALIB_SCAN_RESPONSE = 323,
    AXIS__ENCODER__POS_ABS = 324,
    AXIS__ENCODER__SPI_ERROR_RATE = 325,
    AXIS__ENCODER__CONFIG__MODE = 326,
    AXIS__ENCODER__CONFIG__USE_INDEX = 327,
    AXIS__ENCODER__CONFIG__INDEX_OFFSET = 328,
    AXIS__ENCODER__CONFIG__USE_INDEX_OFFSET = 329,
    AXIS__ENCODER__CONFIG__FIND_IDX_ON_LOCKIN_ONLY = 330,
    AXIS__ENCODER__CONFIG__ABS_SPI_CS_GPIO_PIN = 331,
    AXIS__ENCODER__CONFIG__CPR = 332,
    AXIS__ENCODER__CONFIG__PHASE_OFFSET = 333,
    AXIS__ENCODER__CONFIG__PHASE_OFFSET_FLOAT = 334,
    AXIS__ENCODER__CONFIG__DIRECTION = 335,
    AXIS__ENCODER__CONFIG__PRE_CALIBRATED = 336,
    AXIS__ENCODER__CONFIG__ENABLE_PHASE_INTERPOLATION = 337,
    AXIS__ENCODER__CONFIG__BANDWIDTH = 338,
    AXIS__ENCODER__CONFIG__CALIB_RANGE = 339,
    AXIS__ENCODER__CONFIG__CALIB_SCAN_DISTANCE = 340,
    AXIS__ENCODER__CONFIG__CALIB_SCAN_OMEGA = 341,
    AXIS__ENCODER__CONFIG__IGNORE_ILLEGAL_HALL_STATE = 342,
    AXIS__ENCODER__CONFIG__HALL_POLARITY = 343,
    AXIS__ENCODER__CONFIG__HALL_POLARITY_CALIBRATED = 344,
    AXIS__ENCODER__CONFIG__SINCOS_GPIO_PIN_SIN = 345,
    AXIS__ENCODER__CONFIG__SINCOS_GPIO_PIN_COS = 346,
    AXIS__ACIM_ESTIMATOR__ROTOR_FLUX = 349,
    AXIS__ACIM_ESTIMATOR__SLIP_VEL = 350,
    AXIS__ACIM_ESTIMATOR__PHASE_OFFSET = 351,
    AXIS__ACIM_ESTIMATOR__STATOR_PHASE_VEL = 352,
    AXIS__ACIM_ESTIMATOR__STATOR_PHASE = 353,
    AXIS__ACIM_ESTIMATOR__CONFIG__SLIP_VELOCITY = 354,
    AXIS__SENSORLESS_ESTIMATOR__ERROR = 355,
    AXIS__SENSORLESS_ESTIMATOR__PHASE = 356,
    AXIS__SENSORLESS_ESTIMATOR__PLL_POS = 357,
    AXIS__SENSORLESS_ESTIMATOR__PHASE_VEL = 358,
    AXIS__SENSORLESS_ESTIMATOR__VEL_ESTIMATE = 359,
    AXIS__SENSORLESS_ESTIMATOR__CONFIG__OBSERVER_GAIN = 360,
    AXIS__SENSORLESS_ESTIMATOR__CONFIG__PLL_BANDWIDTH = 361,
    AXIS__SENSORLESS_ESTIMATOR__CONFIG__PM_FLUX_LINKAGE = 362,
    AXIS__TRAP_TRAJ__CONFIG__VEL_LIMIT = 363,
    AXIS__TRAP_TRAJ__CONFIG__ACCEL_LIMIT = 364,
    AXIS__TRAP_TRAJ__CONFIG__DECEL_LIMIT = 365,
    AXIS__MIN_ENDSTOP__ENDSTOP_STATE = 366,
    AXIS__MIN_ENDSTOP__CONFIG__GPIO_NUM = 367,
    AXIS__MIN_ENDSTOP__CONFIG__ENABLED = 368,
    AXIS__MIN_ENDSTOP__CONFIG__OFFSET = 369,
    AXIS__MIN_ENDSTOP__CONFIG__IS_ACTIVE_HIGH = 370,
    AXIS__MIN_ENDSTOP__CONFIG__DEBOUNCE_MS = 371,
    AXIS__MAX_ENDSTOP__ENDSTOP_STATE = 372,
    AXIS__MAX_ENDSTOP__CONFIG__GPIO_NUM = 373,
    AXIS__MAX_ENDSTOP__CONFIG__ENABLED = 374,
    AXIS__MAX_ENDSTOP__CONFIG__OFFSET = 375,
    AXIS__MAX_ENDSTOP__CONFIG__IS_ACTIVE_HIGH = 376,
    AXIS__MAX_ENDSTOP__CONFIG__DEBOUNCE_MS = 377,
    AXIS__MECHANICAL_BRAKE__CONFIG__GPIO_NUM = 378,
    AXIS__MECHANICAL_BRAKE__CONFIG__IS_ACTIVE_LOW = 379,
    AXIS__MECHANICAL_BRAKE__ENGAGE = 380,
    AXIS__MECHANICAL_BRAKE__RELEASE = 381,
    AXIS__TASK_TIMES__THERMISTOR_UPDATE__START_TIME = 382,
    AXIS__TASK_TIMES__THERMISTOR_UPDATE__END_TIME = 383,
    AXIS__TASK_TIMES__THERMISTOR_UPDATE__LENGTH = 384,
    AXIS__TASK_TIMES__THERMISTOR_UPDATE__MAX_LENGTH = 385,
    AXIS__TASK_TIMES__ENCODER_UPDATE__START_TIME = 386,
    AXIS__TASK_TIMES__ENCODER_UPDATE__END_TIME = 387,
    AXIS__TASK_TIMES__ENCODER_UPDATE__LENGTH = 388,
    AXIS__TASK_TIMES__ENCODER_UPDATE__MAX_LENGTH = 389,
    AXIS__TASK_TIMES__SENSORLESS_ESTIMATOR_UPDATE__START_TIME = 390,
    AXIS__TASK_TIMES__SENSORLESS_ESTIMATOR_UPDATE__END_TIME = 391,
    AXIS__TASK_TIMES__SENSORLESS_ESTIMATOR_UPDATE__LENGTH = 392,
    AXIS__TASK_TIMES__SENSORLESS_ESTIMATOR_UPDATE__MAX_LENGTH = 393,
    AXIS__TASK_TIMES__ENDSTOP_UPDATE__START_TIME = 394,
    AXIS__TASK_TIMES__ENDSTOP_UPDATE__END_TIME = 395,
    AXIS__TASK_TIMES__ENDSTOP_UPDATE__LENGTH = 396,
    AXIS__TASK_TIMES__ENDSTOP_UPDATE__MAX_LENGTH = 397,
    AXIS__TASK_TIMES__CAN_HEARTBEAT__START_TIME = 398,
    AXIS__TASK_TIMES__CAN_HEARTBEAT__END_TIME = 399,
    AXIS__TASK_TIMES__CAN_HEARTBEAT__LENGTH = 400,
    AXIS__TASK_TIMES__CAN_HEARTBEAT__MAX_LENGTH = 401,
    AXIS__TASK_TIMES__CONTROLLER_UPDATE__START_TIME = 402,
    AXIS__TASK_TIMES__CONTROLLER_UPDATE__END_TIME = 403,
    AXIS__TASK_TIMES__CONTROLLER_UPDATE__LENGTH = 404,
    AXIS__TASK_TIMES__CONTROLLER_UPDATE__MAX_LENGTH = 405,
    AXIS__TASK_TIMES__OPEN_LOOP_CONTROLLER_UPDATE__START_TIME = 406,
    AXIS__TASK_TIMES__OPEN_LOOP_CONTROLLER_UPDATE__END_TIME = 407,
    AXIS__TASK_TIMES__OPEN_LOOP_CONTROLLER_UPDATE__LENGTH = 408,
    AXIS__TASK_TIMES__OPEN_LOOP_CONTROLLER_UPDATE__MAX_LENGTH = 409,
    AXIS__TASK_TIMES__ACIM_ESTIMATOR_UPDATE__START_TIME = 410,
    AXIS__TASK_TIMES__ACIM_ESTIMATOR_UPDATE__END_TIME = 411,
    AXIS__TASK_TIMES__ACIM_ESTIMATOR_UPDATE__LENGTH = 412,
    AXIS__TASK_TIMES__ACIM_ESTIMATOR_UPDATE__MAX_LENGTH = 413,
    AXIS__TASK_TIMES__MOTOR_UPDATE__START_TIME = 414,
    AXIS__TASK_TIMES__MOTOR_UPDATE__END_TIME = 415,
    AXIS__TASK_TIMES__MOTOR_UPDATE__LENGTH = 416,
    AXIS__TASK_TIMES__MOTOR_UPDATE__MAX_LENGTH = 417,
    AXIS__TASK_TIMES__CURRENT_CONTROLLER_UPDATE__START_TIME = 418,
    AXIS__TASK_TIMES__CURRENT_CONTROLLER_UPDATE__END_TIME = 419,
    AXIS__TASK_TIMES__CURRENT_CONTROLLER_UPDATE__LENGTH = 420,
    AXIS__TASK_TIMES__CURRENT_CONTROLLER_UPDATE__MAX_LENGTH = 421,
    AXIS__TASK_TIMES__DC_CALIB__START_TIME = 422,
    AXIS__TASK_TIMES__DC_CALIB__END_TIME = 423,
    AXIS__TASK_TIMES__DC_CALIB__LENGTH = 424,
    AXIS__TASK_TIMES__DC_CALIB__MAX_LENGTH = 425,
    AXIS__TASK_TIMES__CURRENT_SENSE__START_TIME = 426,
    AXIS__TASK_TIMES__CURRENT_SENSE__END_TIME = 427,
    AXIS__TASK_TIMES__CURRENT_SENSE__LENGTH = 428,
    AXIS__TASK_TIMES__CURRENT_SENSE__MAX_LENGTH = 429,
    AXIS__TASK_TIMES__PWM_UPDATE__START_TIME = 430,
    AXIS__TASK_TIMES__PWM_UPDATE__END_TIME = 431,
    AXIS__TASK_TIMES__PWM_UPDATE__LENGTH = 432,
    AXIS__TASK_TIMES__PWM_UPDATE__MAX_LENGTH = 433,
    AXIS__WATCHDOG_FEED = 434,
};
...
template<> struct endpoint_type<AXIS__CONTROLLER__CONFIG__VEL_INTEGRATOR_LIMIT> { typedef float type; };
